...
class AutoLabel:
    def __init__(self, processingFolder, confidence = 0.9, iou = 0.7):
        ...
        self.loadmodel = DetectMultiBackend(MODEL_PATH,CUDA_DEVICE , dnn=False ,data=None ,fp16=False)
        if self.loadmodel:
            print("Model Loaded")
    ...
    def Label(self):
        ...
        for image in tqdm.tqdm(images):
            detectLabels = imageDetect(image,CUDA_DEVICE,self.loadmodel,CONFIDENCE_THRESH)
